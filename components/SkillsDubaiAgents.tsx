      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-[#1A1A1A] rounded-2xl p-6 text-left">
            <FaMicrophone className="text-[#F8C133] text-2xl mb-4" />
            <h3 className="text-white text-xl font-semibold mb-2">Communication Skills</h3>
          ...
          {/* CARD 2 (YELLOW) */}
          <div className="bg-[#F8C133] rounded-2xl p-6 text-left">
            <FaRocket className="text-black text-2xl mb-4" />
            <h3 className="text-black text-xl font-semibold mb-2">Performance Mindset</h3>
          ...
          {/* CARD 3 */}
          <div className="bg-[#1A1A1A] rounded-2xl p-6 text-left">
            <FaHandshake className="text-[#F8C133] text-2xl mb-4" />
            <h3 className="text-white text-xl font-semibold mb-2">Negotiation Strategy</h3>
            <p className="text-[#C7C7C7] text-sm leading-relaxed">
          ...
          {/* CARD 4 */}
          <div className="bg-[#1A1A1A] rounded-2xl p-6 text-left">
            <FaUser className="text-[#F8C133] text-2xl mb-4" />
          ...
          <div className="flex items-center justify-center">
            <div className="text-center">
              <Image src={logo} alt="Performance Mentorship" className="mx-auto mb-4 w-28" />
              <p className="text-[#F8C133] uppercase tracking-widest text-sm font-semibold">
                PERFORMANCE <br /> MENTORSHIP
              </p>
            </div>
          </div>
          ...
          {/* CARD 5 */}
          <div className="bg-[#1A1A1A] rounded-2xl p-6 text-left">
            <FaLightbulb className="text-[#F8C133] text-2xl mb-4" />
            <h3 className="text-white text-xl font-semibold mb-2">Daily Execution Discipline</h3>
            <p className="text-[#C7C7C7] text-sm leading-relaxed">
